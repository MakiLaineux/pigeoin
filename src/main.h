...
static const int64 MAX_MONEY = 28800 * COIN; // JCMOD maximum of 28800 coins
...
public:
    ...
    */
	...
	// JC : always allow free transactions
	return true;
        //return dPriority > COIN * 480 / 250; // JCMOD 480 blocks found a day. Priority cutoff is 1 PGN day / 250 bytes.
    }
