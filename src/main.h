...
static const int64 MAX_MONEY = 1000 * COIN; // maximum of 1000 coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 480 / 250; // 480 blocks found a day. Priority cutoff is 1 PGN day / 250 bytes.
    }
